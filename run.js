...
program
  ...
  .option('--accessibility <threshold>', `accessibility score for each site to meet (1-100)`, thresholdValid)
  .option('--performance <threshold>', `performance score for each site to meet (1-100)`, thresholdValid)
  .option('--best-practices <threshold>', `best practice score for each site to meet (1-100)`, thresholdValid)
  .option('--seo <threshold>', `seo score for each site to meet (1-100)`, thresholdValid)
  .option('--pwa <threshold>', `pwa score for each site to meet (1-100)`, thresholdValid)
